...
public class SimulationEnvironment {
	...
	public String nmap_ports(String ip) {
		...
		if(this.backgrounded && ip.equals(this.ip_visible)) {
		...
		for(Machine machine: this.machines) {
			if(machine.ip_address.equals(ip)) {
	...
	public String dirtyCow() {
		// TODO Auto-generated method stub
		for(Machine machine: this.machines) {
			if(machine.ip_address.equals(this.ip_vulnerable)) {
				if(machine.shell_open) {
	...
	public String pivot_autoroute() {
		// TODO Auto-generated method stub
		if(this.backgrounded==true && this.last_opened_shell!=null && this.last_opened_shell.equals("meterpreter")==false ) {
			for(Machine machine: this.machines) {
				if(machine.ip_address.equals(this.last_opened_shell)) {
					String result=machine.pivot_autoroute(this.session);
					System.out.println("BLUUP XXXXX: "+ result);
					if(result!="Command not found") {
