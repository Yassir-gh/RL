...
class QLearningTable:
    ...
    def initialise_state_actions(self): # à compléter
        return {
                #"{'port139': True, 'port21': True, 'port3306': True, 'port22': True}": [self.ssh_login, self.samba, self.ftp1, self.mysql, self.distcc, self.postgresql],
                "{'port139': True, 'port21': True, 'port3306': True, 'port22': True}": [self.ftp1, self.mysql, self.postgresql],
